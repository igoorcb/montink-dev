...
@section('title', 'Carrinho - Montink ERP')
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-200">
                                <th class="text-left py-3 px-4 font-semibold text-gray-900">Produto</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-900">Preço Unit.</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-900">Quantidade</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-900">Total</th>
                                <th class="text-left py-3 px-4 font-semibold text-gray-900">Ações</th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            @if($item['variation'])
                                            <p class="text-sm text-gray-500">Variação: {{ $item['variation'] }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="text-center py-12">
                    <i class="bi bi-cart-x text-6xl text-gray-400 mb-6"></i>
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Carrinho vazio</h3>
                    <p class="text-gray-500 mb-6">Adicione produtos ao seu carrinho para continuar</p>
        ...
        <div class="card sticky top-24">
            ...
            <div class="card-body">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex">
                        <input type="text" class="form-input rounded-r-none" id="couponCode" placeholder="Digite o código">
                    ...
                    <div class="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="font-medium text-green-800">Cupom aplicado: {{ $appliedCoupon->code }}</p>
                                <p class="text-sm text-green-600">Desconto: {{ $appliedCoupon->type === 'percentage' ? $appliedCoupon->value . '%' : 'R$ ' . number_format($appliedCoupon->value, 2, ',', '.') }}</p>
                            </div>
                ...
                <a href="{{ route('orders.checkout') }}" class="w-full btn-success text-center">
                    <i class="bi bi-check-circle"></i>
                    Finalizar Compra
                </a>
                @else
                <div class="text-center py-8">
                    <i class="bi bi-receipt text-4xl text-gray-400 mb-4"></i>
